...
class HomeController
{
    public function index()
    {
        ...
        $settings3 = [
            'chart_title'           => 'Today\'s Appointments',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Appointment',
            'group_by_field'        => 'date',
        ...
        $settings5 = [
            'chart_title'           => 'Count Appointments',
            'chart_type'            => 'bar',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Appointment',
            'group_by_field'        => 'date',
        ...
        $settings7 = [
            'chart_title'           => 'Latest 5 Requested Apointments',
        ...
        $settings8 = [
            'chart_title'           => 'Latest 5 Registered Clients',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Client',
            'group_by_field'        => 'created_at',
        ...
        return view('admin.home', compact('chart5', 'settings1', 'settings2', 'settings3', 'settings4', 'settings6', 'settings7', 'settings8'));
    }
}
