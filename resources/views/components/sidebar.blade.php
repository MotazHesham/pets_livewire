        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('client_managment_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/clients*")||request()->is("admin/pets*")||request()->is("admin/appointments*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-users">
                            </i>
                ...
                @can('package_managment_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/addons*")||request()->is("admin/packages*")||request()->is("admin/services*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-box-open">
                            </i>
                        ...
                        <ul class="ml-4 subnav hidden">
                            @can('addon_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/addons*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.addons.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-plus-circle">
                                        </i>
                ...
                @can('general_setting_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/settings*")||request()->is("admin/sliders*")||request()->is("admin/categories*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
